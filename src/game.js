...
map.setTile(0,0, 'Sand all around you, not a single plant grows here,\nnot a single drop of water for a log time have touched this cursed land.');
...
console.log('Hello & welcome to The Quest.');
console.log(`Check prompt for exits (nswe). Type exit letter to move around.`);
console.log(`===============================================================\n`);

console.log(player.look().where);
const rl = readline.createInterface(process.stdin, process.stdout);

rl.setPrompt(`${player.look().exits}> `);
rl.prompt();
